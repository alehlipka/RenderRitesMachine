...
public abstract class GuiElement
{
    ...
    private void ApplyAdaptivePosition(Vector2i parentSize)
    {
        int x = HorizontalAnchor switch
        {
            ...
            GuiHorizontalAnchor.Center => Margin.Left + GetCenteredOffset(parentSize.X, Margin.Horizontal, Width) + _position.X,
        ...
        int y = VerticalAnchor switch
        {
            ...
            GuiVerticalAnchor.Center => Margin.Top + GetCenteredOffset(parentSize.Y, Margin.Vertical, Height) + _position.Y,
