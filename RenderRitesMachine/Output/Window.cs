...
public class Window(GameWindowSettings gws, NativeWindowSettings nws, GuiService guiService, SceneManager sceneManager, ILogger? logger = null) : GameWindow(gws, nws)
{
