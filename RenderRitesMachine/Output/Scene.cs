...
public abstract class Scene : IDisposable
{
    ...
    protected Scene(string name, IAssetsService assetsService, ITimeService timeService, IRenderService renderService, IGuiService guiService, IAudioService audioService, ISceneManager sceneManager, ILogger logger)
    {
        _timeService = timeService;
        Camera = new PerspectiveCamera();
        Assets = assetsService;
        Audio = audioService;
        _shared = new SystemSharedObject(Camera, _timeService, Assets, renderService, guiService, audioService, sceneManager, logger);
